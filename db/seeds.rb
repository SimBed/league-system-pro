...
Participation.create!(score: 10, match: match1, participant_type: 'Player', participant_id: Dan.id)
Participation.create!(score: 5, match: match1, participant_type: 'Player', participant_id: Kev.id)
Participation.create!(score: 0, match: match1, participant_type: 'Player', participant_id: Andy.id)

match2 = Match.create!(date: Date.parse('2 July 2025'), league: league1)

Participation.create!(score: 3, match: match2, participant_type: 'Player', participant_id: Dan.id)
Participation.create!(score: 6, match: match2, participant_type: 'Player', participant_id: Kev.id)
Participation.create!(score: 2, match: match2, participant_type: 'Player', participant_id: Andy.id)

match3 = Match.create!(date: Date.parse('3 July 2025'), league: league2)

Participation.create!(score: 4, match: match3, participant_type: 'Player', participant_id: Dan.id)
Participation.create!(score: 2, match: match3, participant_type: 'Player', participant_id: Kev.id)
Participation.create!(score: 4, match: match3, participant_type: 'Player', participant_id: Andy.id)
